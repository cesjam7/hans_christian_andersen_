                ...
                <div class="blog-single">
                    <div class="container">
                        <div class="row">
                            ...
                            <!-- SINGLE POST START
                            ============================================= -->
                            <div class="single-post col-md-push-2 col-md-8 wow fadeIn">
                                <article class="post-item">                   
                                    <div class="heading-block">
                                            <a href="single-post.html"><h1 class="text-center">Inicial - 3 años</h1></a>
                                        </div>
                                    <div class="post-image">
                                        <a href="single-post.html">
                                            <img src="img\blog\blog-img-1.jpg" >
                                        </a>
                                    </div>
                                    <div class="post-content">

                                        <div class="content">
                                            <p>La fundación del Colegio se remonta al año 1987 y está íntimamente ligada a la historia de la lucha social y económica de la población de Villa El Salvador por trabajo, educación y cultura.</p>
                                            <p>La Directora y fundadora del plantel Teófila S. Valencia Atencio, licenciada de la Universidad Nacional Enrique Guzmán y Valle, el año 1978 es nombrada directora del CEI N° 517 que, por la misma situación económica política y social que vivía la joven Comunidad Autogestionaria de Villa El Salvador, se desenvolvía en medio de las necesidades y el caos reinante del sistema educativo: pésimas condiciones infraestructurales y personal docente improvisado y sin especialización.</p>
                                        </div>
                                    </div>
                                </article>
                            </div>
